...
public class PizzaBuilder {
	...
	private static JLabel sizeList = new JLabel("Size List: ");
	...
	private static JCheckBox sausage, pepperoni, chicken, anchovies;
	...
	private static JPanel makePizzaPanel() {
		...
		jp.add(chicken);
		chicken.addItemListener(new pizzaToppingListen());
